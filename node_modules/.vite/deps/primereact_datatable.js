import {
  CheckIcon
} from "./chunk-6AKXKNYS.js";
import {
  AngleRightIcon
} from "./chunk-HR2S4FQJ.js";
import {
  InputText
} from "./chunk-RO6O7X5M.js";
import {
  ChevronDownIcon,
  Dropdown,
  VirtualScroller
} from "./chunk-ZFQLGBWJ.js";
import {
  TimesIcon
} from "./chunk-VK6OOPON.js";
import {
  OverlayService
} from "./chunk-2UAVFEFT.js";
import {
  CSSTransition
} from "./chunk-XG2CZXZV.js";
import "./chunk-QF7CRRC5.js";
import {
  Button
} from "./chunk-B5IY6BEZ.js";
import {
  SpinnerIcon
} from "./chunk-QOKMCK5C.js";
import {
  Ripple
} from "./chunk-P2E3WE63.js";
import {
  Tooltip
} from "./chunk-AQVKWTRS.js";
import {
  Portal,
  useEventListener,
  useMountEffect,
  ...
  useUnmountEffect,
  useUpdateEffect
} from "./chunk-OIELQCD4.js";
import "./chunk-NGP3Y3H7.js";
import {
  ChevronRightIcon
} from "./chunk-5TEMSYAQ.js";
import {
  IconBase
} from "./chunk-2A7SLJML.js";
import {
  ComponentBase
} from "./chunk-5T6K3NY7.js";
import {
  DomHandler,
  FilterMatchMode,
  FilterOperator,
...
var ObjectUtils2 = (function() {
  ...
  _createClass(ObjectUtils12, null, [{
    ...
    key: "combinedRefs",
    value: function combinedRefs(innerRef, forwardRef20) {
      if (innerRef && forwardRef20) {
        if (typeof forwardRef20 === "function") {
          forwardRef20(innerRef.current);
        } else {
          forwardRef20.current = innerRef.current;
        }
      }
    }
  }, {
...
var InputNumber = React6.memo(React6.forwardRef(function(inProps, ref) {
  ...
  return React6.createElement(React6.Fragment, null, React6.createElement("span", rootProps, inputElement, buttonGroup), hasTooltip && React6.createElement(Tooltip, _extends6({
    target: elementRef,
...
var PrevPageLink = React9.memo(function(inProps) {
  ...
  var prevPageLinkIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, prevPageIconProps), {
    props
  });
...
var RowsPerPageDropdown = React9.memo(function(inProps) {
  ...
  var element = hasOptions ? React9.createElement(Dropdown, {
    value: props.value,
    options,
...
var PencilIcon = React11.memo(React11.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var FilterIcon = React12.memo(React12.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var FilterSlashIcon = React13.memo(React13.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var PlusIcon = React14.memo(React14.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var SortAmountUpAltIcon = React18.memo(React18.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React18.useState(inProps.id), _React$useState2 = _slicedToArray12(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
...
var RowCheckbox = React19.memo(function(props) {
  var _React$useState = React19.useState(false), _React$useState2 = _slicedToArray13(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  ...
  return React19.createElement("div", checkboxWrapperProps, React19.createElement("div", checkboxProps, checkIcon));
});
...
var RowRadioButton = React19.memo(function(props) {
  ...
  return React19.createElement("div", radiobuttonWrapperProps, React19.createElement("div", hiddenInputWrapperProps, React19.createElement("input", _extends18({
    ref: inputRef
  }, hiddenInputProps))), React19.createElement("div", radiobuttonProps, React19.createElement("div", radiobuttonIconProps)));
});
...
var BodyCell = React19.memo(function(props) {
  var _React$useState = React19.useState(props.editing), _React$useState2 = _slicedToArray13(_React$useState, 2), editingState = _React$useState2[0], setEditingState = _React$useState2[1];
  var _React$useState3 = React19.useState(props.rowData), _React$useState4 = _slicedToArray13(_React$useState3, 2), editingRowDataState = _React$useState4[0], setEditingRowDataState = _React$useState4[1];
  var _React$useState5 = React19.useState({}), _React$useState6 = _slicedToArray13(_React$useState5, 2), styleObjectState = _React$useState6[0], setStyleObjectState = _React$useState6[1];
  ...
  var _useEventListener = useEventListener({
    ...
    options: true
  }), _useEventListener2 = _slicedToArray13(_useEventListener, 2), bindDocumentClickListener = _useEventListener2[0], unbindDocumentClickListener = _useEventListener2[1];
  ...
  var createElement20 = function createElement21() {
    ...
    var className = classNames(bodyClassName, getColumnProp("className"), cellClassName, _defineProperty3({
    ...
    if (selectionMode) {
      ...
      var rowReorderIcon = getColumnProp("rowReorderIcon") || React19.createElement(BarsIcon, {
      ...
      var rowEditorSaveIcon = IconUtils.getJSXIcon(props.rowEditorSaveIcon || React19.createElement(CheckIcon, rowEditorSaveIconProps), _objectSpread$9({}, rowEditorSaveIconProps), {
        props
      });
      var rowEditorCancelIcon = IconUtils.getJSXIcon(props.rowEditorCancelIcon || React19.createElement(TimesIcon, rowEditorCancelIconProps), _objectSpread$9({}, rowEditorCancelIconProps), {
        props
      });
      var rowEditorInitIcon = IconUtils.getJSXIcon(props.rowEditorInitIcon || React19.createElement(PencilIcon, rowEditorInitIconProps), _objectSpread$9({}, rowEditorInitIconProps), {
        props
      });
      if (editingState) {
        rowEditorProps = {
        ...
        content = React19.createElement(React19.Fragment, null, React19.createElement("button", rowEditorEditButtonProps, rowEditorSaveIcon, React19.createElement(Ripple, null)), React19.createElement("button", rowEditorCancelButtonProps, rowEditorCancelIcon, React19.createElement(Ripple, null)));
      } else {
        rowEditorProps = {
          editing: false,
...
var BodyRow = React19.memo(function(props) {
  var _React$useState = React19.useState(false), _React$useState2 = _slicedToArray13(_React$useState, 2), editingState = _React$useState2[0], setEditingState = _React$useState2[1];
...
var TableBody = React19.memo(React19.forwardRef(function(props, ref) {
  var _React$useState = React19.useState({}), _React$useState2 = _slicedToArray13(_React$useState, 2), rowGroupHeaderStyleObjectState = _React$useState2[0], setRowGroupHeaderStyleObjectState = _React$useState2[1];
  var getColumnProps = function getColumnProps2(column) {
    return ColumnBase.getCProps(column);
  };
  var getColumnPTOptions = function getColumnPTOptions2(key) {
...
var FooterCell = React19.memo(function(props) {
  var _React$useState = React19.useState({}), _React$useState2 = _slicedToArray13(_React$useState, 2), styleObjectState = _React$useState2[0], setStyleObjectState = _React$useState2[1];
  var elementRef = React19.useRef(null);
  var getColumnProps = function getColumnProps2() {
    return ColumnBase.getCProps(props.column);
  };
  ...
  var className = classNames(getColumnProp("footerClassName"), getColumnProp("className"), _defineProperty3({
...
var ColumnFilter = React19.memo(function(props) {
  var _React$useState = React19.useState(false), _React$useState2 = _slicedToArray13(_React$useState, 2), overlayVisibleState = _React$useState2[0], setOverlayVisibleState = _React$useState2[1];
  ...
  }), _useOverlayListener2 = _slicedToArray13(_useOverlayListener, 2), bindOverlayListener = _useOverlayListener2[0], unbindOverlayListener = _useOverlayListener2[1];
  ...
  var createOverlay = function createOverlay2() {
    ...
    return React19.createElement(Portal, null, React19.createElement(CSSTransition, {
      nodeRef: overlayRef,
    ...
    }, React19.createElement("div", _extends18({
      ref: overlayRef
  ...
  return React19.createElement("div", columnFilter, rowFilterElement, menuButton, clearButton, overlay);
});
...
var HeaderCheckbox = React19.memo(function(props) {
  ...
  return React19.createElement("div", headerCheckboxWrapperProps, React19.createElement("div", headerCheckboxProps, checkIcon));
});
...
var HeaderCell = React19.memo(function(props) {
  ...
  var createElement20 = function createElement21() {
    ...
    var frozen = getColumnProp("frozen");
    var className = classNames(getColumnProp("headerClassName"), getColumnProp("className"), _defineProperty3({
...
var TableHeader = React19.memo(function(props) {
  var _React$useState = React19.useState([]), _React$useState2 = _slicedToArray13(_React$useState, 2), sortableDisabledFieldsState = _React$useState2[0], setSortableDisabledFieldsState = _React$useState2[1];
  var _React$useState3 = React19.useState(false), _React$useState4 = _slicedToArray13(_React$useState3, 2), allSortableDisabledState = _React$useState4[0], setAllSortableDisabledState = _React$useState4[1];
...
var DataTable = React19.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React19.useState(props.first), _React$useState2 = _slicedToArray13(_React$useState, 2), firstState = _React$useState2[0], setFirstState = _React$useState2[1];
  var _React$useState3 = React19.useState(props.rows), _React$useState4 = _slicedToArray13(_React$useState3, 2), rowsState = _React$useState4[0], setRowsState = _React$useState4[1];
  var _React$useState5 = React19.useState(props.sortField), _React$useState6 = _slicedToArray13(_React$useState5, 2), sortFieldState = _React$useState6[0], setSortFieldState = _React$useState6[1];
  var _React$useState7 = React19.useState(props.sortOrder), _React$useState8 = _slicedToArray13(_React$useState7, 2), sortOrderState = _React$useState8[0], setSortOrderState = _React$useState8[1];
  var _React$useState9 = React19.useState(props.multiSortMeta), _React$useState10 = _slicedToArray13(_React$useState9, 2), multiSortMetaState = _React$useState10[0], setMultiSortMetaState = _React$useState10[1];
  var _React$useState11 = React19.useState(props.filters), _React$useState12 = _slicedToArray13(_React$useState11, 2), filtersState = _React$useState12[0], setFiltersState = _React$useState12[1];
  var _React$useState13 = React19.useState([]), _React$useState14 = _slicedToArray13(_React$useState13, 2), columnOrderState = _React$useState14[0], setColumnOrderState = _React$useState14[1];
  var _React$useState15 = React19.useState(null), _React$useState16 = _slicedToArray13(_React$useState15, 2), groupRowsSortMetaState = _React$useState16[0], setGroupRowsSortMetaState = _React$useState16[1];
  var _React$useState17 = React19.useState({}), _React$useState18 = _slicedToArray13(_React$useState17, 2), editingMetaState = _React$useState18[0], setEditingMetaState = _React$useState18[1];
  var _React$useState19 = React19.useState(props.rows), _React$useState20 = _slicedToArray13(_React$useState19, 2), d_rowsState = _React$useState20[0], setD_rowsState = _React$useState20[1];
  var _React$useState21 = React19.useState({}), _React$useState22 = _slicedToArray13(_React$useState21, 2), d_filtersState = _React$useState22[0], setD_filtersState = _React$useState22[1];
  var metaData = {
    props,
    state: {
      first: firstState,
  ...
  }), _useEventListener2 = _slicedToArray13(_useEventListener, 2), bindDocumentMouseMoveListener = _useEventListener2[0], unbindDocumentMouseMoveListener = _useEventListener2[1];
  ...
  }), _useEventListener4 = _slicedToArray13(_useEventListener3, 2), bindDocumentMouseUpListener = _useEventListener4[0], unbindDocumentMouseUpListener = _useEventListener4[1];
  ...
  var allRowsSelected = function allRowsSelected2(processedData2) {
    if (props.onSelectAllChange) {
      ...
      var val = ObjectUtils.isNotEmpty(props.frozenValue) ? [].concat(_toConsumableArray2(props.frozenValue), _toConsumableArray2(_data)) : _data;
  ...
  var onColumnHeaderCheckboxChange = function onColumnHeaderCheckboxChange2(e, processedData2) {
    if (props.onSelectAllChange) {
      ...
      if (checked) {
        selection = ObjectUtils.isNotEmpty(props.frozenValue) ? [].concat(_toConsumableArray2(selection), _toConsumableArray2(props.frozenValue), _toConsumableArray2(_data2)) : [].concat(_toConsumableArray2(selection), _toConsumableArray2(_data2));
  ...
  var cloneFilters = function cloneFilters2(filters) {
    ...
    if (filters) {
      Object.entries(filters).forEach(function(_ref) {
        var _ref2 = _slicedToArray13(_ref, 2), prop = _ref2[0], value = _ref2[1];
  ...
  var createContent = function createContent2(processedData2, columns2, selectionModeInColumn2, empty2) {
    ...
    return React19.createElement("div", _extends18({
      ...
      contentTemplate: function contentTemplate(options) {
        ...
        return React19.createElement("table", tableProps, tableHeader, tableBody, tableFooter);
      }
    })));
  };
